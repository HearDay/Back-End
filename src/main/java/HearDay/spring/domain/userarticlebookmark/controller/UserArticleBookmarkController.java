...
public class UserArticleBookmarkController {
        ...
        return ResponseEntity.status(HttpStatus.OK)
                .body(
                        CommonApiResponse.success(
                                userArticleBookmarkService.getBookmarkArticles(page, user.getId())));
    }
    ...
    public ResponseEntity<CommonApiResponse<Void>> addBookmark(
            ...
            Long articleId) {
        userArticleBookmarkService.addBookmark(articleId, user);
    ...
    public ResponseEntity<CommonApiResponse<Void>> removeBookmark(
            @AuthUser User user,
            @PathVariable Long articleId
    ) {
        userArticleBookmarkService.removeBookmark(user.getId(), articleId);
        return ResponseEntity.status(HttpStatus.OK).body(CommonApiResponse.success(null));
    }
}
